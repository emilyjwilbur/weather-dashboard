window.addEventListener('load', function () {
  ...
  function getForecast(searchValue) {
    ...
    var endpoint = `https://api.openweathermap.org/data/2.5/forecast?q=${searchValue}&appid=ba9531337e96e3ddba6fccf15d1d0b48
    &units=imperial`;
    fetch(endpoint)
      .then((res) => res.json())
      .then((data) => {
  ...
  function getUVIndex(lat, lon) {
    fetch(
      `https://api.openweathermap.org/data/2.5/uvi?appid=ba9531337e96e3ddba6fccf15d1d0b48
      &lat=${lat}&lon=${lon}`
    )
      .then((res) => res.json())
      .then((data) => {
  ...
  function searchWeather(searchValue) {
    var endpoint = `https://api.openweathermap.org/data/2.5/weather?q=${searchValue}&appid=ba9531337e96e3ddba6fccf15d1d0b48
    &units=imperial`;
    fetch(endpoint)
      .then((res) => res.json())
      .then((data) => {
